...
\hypersetup{
  ...
  pdfauthor={Faculty: Jared Simpson, Gary van Domselaar, Andrew McArthur, Rob Beiko, Fiona Brinkman},
  hidelinks,
...
\chapter{Module 1 Genome Assembly}\label{module-1-genome-assembly}

\section{Lecture}\label{lecture}

\section{Lab}\label{lab}

\chapter{Module 2 Genome Annotation}\label{module-2-genome-annotation}

\section{Lecture}\label{lecture-1}

\section{Lab}\label{lab-1}

\chapter{Module 3 Antimicrobial Resistant Gene (AMR) Analysis}\label{module-3-antimicrobial-resistant-gene-amr-analysis}

\section{Lecture}\label{lecture-2}

\section{Lab}\label{lab-2}

\chapter{Module 4 Mobile Genetic Elements}\label{module-4-mobile-genetic-elements}

\section{Lecture}\label{lecture-3}

\section{Lab}\label{lab-3}

\chapter{Module 5 Pan Genomis}\label{module-5-pan-genomis}
