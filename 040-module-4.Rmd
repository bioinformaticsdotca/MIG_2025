...
<iframe width="640" height="360" src="https://www.youtube.com/embed/OXwLQmg7xUg?si=JXIqlAJCbGh6keKL" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

## Lecture
<iframe src="https://drive.google.com/file/d/1koc2kciWtqzdavZz8ilwwI_ROWG8KZga/preview" width="640" height="480" allow="autoplay"></iframe> 
...
If you are doing this demo live, you can download all the files we will be viewing [here](https://github.com/bioinformaticsdotca/MIG_2025/tree/main/module4/downloads_for_demo).
...
### CARD Website and Antibiotic Resistance Ontology {#cardweb}
...
### RGI for Genome Analysis {#rgigenome}
...
### RGI at the Command Line {#rgicommand}
...
We don’t have time to analyze all 39 samples, so let’s analyze 1 as an example (the course GitHub repo contains an EXCEL version of the resulting [ED010.txt](https://github.com/bioinformaticsdotca/MIG_2025/tree/main/module4/rgi_main_results) file). When analyzing FASTA files we use the **main** sub-command, here with default settings “**Perfect and Strict hits only**”, "**Exclude nudge**", and "**High quality/coverage**":
...
What if these results did not explain our observed phenotype? We might want to explore the RGI Loose hits (the course GitHub repo contains an EXCEL version of the resulting [ED010_IncludeLoose.txt](https://github.com/bioinformaticsdotca/MIG_2025/tree/main/module4/rgi_main_results) file), shown here with settings “**Perfect, Strict, and Loose hits**”, "**Include nudge**", and "**High quality/coverage**":
...
We have pre-compiled results for all 39 samples under “**Perfect and Strict hits only**"", "**Exclude nudge**", and "**High quality/coverage**", so let’s try RGI’s heat map tool ([pre-compiled images](https://github.com/bioinformaticsdotca/MIG_2025/tree/main/module4/rgi_main_results) can be downloaded or viewed from the course GitHub repo):
...
You can use the following annotation file to visualize all of the RGI results in the context of [Microreact](https://microreact.org) visualizations of a phylogenetic tree of these isolates: [RGI microreact results plus earlier derived whole genome SNP tree](https://github.com/bioinformaticsdotca/MIG_2025/tree/main/module4/for_microreact).
...
### RGI for Merged Metagenomic Reads {#rgimerged}
...
### Metagenomic Sequencing Reads and the KMA Algorithm {#bwt}
...
However, the file we are most interested in for now is [`gut_sample.kma.gene_mapping_data.txt`](https://github.com/bioinformaticsdotca/MIG_2025/tree/main/module4/rgi_bwt_results) and the course GitHub repo contains an EXCEL version for easy viewing, but let's look at it on the command line:
...
The pre-compiled results can be viewed in the EXCEL version of [`gut_sample_wildcard.kma.gene_mapping_data.txt`](https://github.com/bioinformaticsdotca/MIG_2025/tree/main/module4/rgi_bwt_results) in the GitLab repo, but let's first compare statistics, where you'll see we aligned some additional reads:
